...
try {
    $query = "SELECT 
                ...
                d.npi_number,
                (SELECT COUNT(DISTINCT patient_id) FROM appointments WHERE doctor_id = u.user_id) as total_patients
              FROM users u
              LEFT JOIN doctor_details d ON u.user_id = d.user_id
              WHERE u.account_type = 'Doctor'
...
<body>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($doctor['specialization'] ?? 'Not specified'); ?></td>
                                <td><?php echo htmlspecialchars($doctor['total_patients']); ?></td>
                                <td>
                                    <span class="status-badge <?php echo $doctor['user_status'] === 'active' ? 'status-active' : 'status-inactive'; ?>">
                                        <?php echo ucfirst(htmlspecialchars($doctor['user_status'] ?? 'inactive')); ?>
                                    </span>
                                </td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="action-btn edit-btn" onclick="editDoctor(<?php echo $doctor['user_id']; ?>)">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button class="action-btn delete-btn" onclick="deleteDoctor(<?php echo $doctor['user_id']; ?>)">
    ...
    <script>
        ...
        document.querySelector('.search-input').addEventListener('input', function(e) {
            ...
            rows.forEach(row => {
                const name = row.querySelector('.doctor-info').textContent.toLowerCase();
